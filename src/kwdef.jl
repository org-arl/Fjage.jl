# Patch for @kwdef for Julia 1.10 and earlier versions.

# Fixed in Base Julia in https://github.com/JuliaLang/julia/pull/53230 and
# available in Julia 1.11 and later versions.
